...
class PinnedCatalogProtocol(Protocol):
    ...
    def probe_entity_values(self, attribute_record_id: str, value: str, **kwargs) -> dict: ...
    def search_entity_values(self, attribute_record_id: str, value: str, **kwargs) -> dict: ...
